  ...
  testCase "rejects invalid symbols in args" $ do
    ...
    traverse_
      ( \args -> do
          ...
          actual <-
            requireLeft
              ("expected Left for args symbols: " ++ show args)
  ...
  testCase "rejects invalid symbols in header" $ do
    ...
    traverse_
      ( \header -> do
          ...
          actual <-
            requireLeft
              ("expected Left for header symbols: " ++ show header)
